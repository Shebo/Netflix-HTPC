...
(function() {
  var alert, alertMsgs, capitalizeFirstLetter, carouselNormalization, clearInput, getChromeStorage, initGamepad, inputs, isEmpty, mapToKeyName, set, shortcuts, supportGamepad, update, validate,
